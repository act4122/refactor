...
public class SecondScreen extends JPanel implements ActionListener, ChangeListener {

	public static final String TITLE = "Second Screen";
	...
	public SecondScreen( CheckersGame game) {
	...
	private void initComponents() {
		...
		add(timedGameBox, gridBagConstraints1);
		...
		gridBagConstraints1.insets = new Insets(5, 0, 0, 0);
		gridBagConstraints1.anchor = GridBagConstraints.WEST;
		add(playerOneField, gridBagConstraints1);
		...
		gridBagConstraints1.insets = new Insets(4, 0, 0, 0);
		gridBagConstraints1.anchor = GridBagConstraints.WEST;
		add(playerTwoField, gridBagConstraints1);
		...
		gridBagConstraints1.anchor = GridBagConstraints.WEST;
		add(turnLengthLabel, gridBagConstraints1);
		...
		gridBagConstraints1.anchor = GridBagConstraints.WEST;
		add(WarningLengthLabel, gridBagConstraints1);
		...
		gridBagConstraints1.gridx = 1;
		gridBagConstraints1.gridy = 6;
		add(turnLengthField, gridBagConstraints1);
		...
		gridBagConstraints1.gridx = 1;
		gridBagConstraints1.gridy = 8;
		add(warningLengthField, gridBagConstraints1);
